...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-2.3-kirby-problem-2.3-7be14026-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-2.3"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-2.3-kirby-problem-2.3-7be14026-v1",
      "problem_contract_sha256": "de3840ee96276a070e7f0b23e9ddd32a35bcb36f60190445e3f1dbff27df0935",
      "problem_id": "problem:um-kp-2.3-kirby-problem-2.3-7be14026",
      "route_id": "route:um-kp-2.3-kirby-problem-2.3-7be14026-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-2.3-kirby-problem-2.3-7be14026-source-fidelity-01",
      "graph_id": "graph:um-kp-2.3-kirby-problem-2.3-7be14026-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-2.3-kirby-problem-2.3-7be14026-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-2.3-kirby-problem-2.3-7be14026-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Is the mapping class group of a surface of finite type linear?"
          },
          "statement_sha256": "c67bd0e191718738cff1fe3e8f25e921c9323b1ec27b706145e2b9be99ed473b"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-2.3-kirby-problem-2.3-7be14026-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-2.3-kirby-problem-2.3-7be14026-root",
      "route_id": "route:um-kp-2.3-kirby-problem-2.3-7be14026-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-2.3-718170801dc0",
        "url": "https://www.unsolvedmath.com/problems/KP-2.3"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
